...
export interface paths {
    ...
    "/ontologies": {
        ...
        /**
         * List ontologies
         * @description Gets the list of ontologies under the parent catalog and schema.
         */
        get: operations["listOntologies"];
        put?: never;
        /**
         * Create ontology
         * @description Creates a new ontology in the specified catalog and schema.
         *     An ontology defines the graph data model (node classes and relationship types) for property graphs.
         */
        post: operations["createOntology"];
        delete?: never;
        options?: never;
        head?: never;
        patch?: never;
    ...
    "/ontologies/{full_name}": {
        parameters: {
            ...
            header?: never;
            path: {
                /** @description Full name of the ontology (catalog.schema.ontology_name). */
                full_name: string;
            };
            cookie?: never;
        };
        /**
         * Get ontology
         * @description Gets the specified ontology including its node classes and relationship types.
         */
        ...
        /**
         * Delete ontology
         * @description Deletes the specified ontology from the parent catalog and schema.
         */
        ...
        /**
         * Update ontology
         * @description Updates the specified ontology.
         */
        patch: operations["updateOntology"];
        trace?: never;
    };
...
export interface components {
    schemas: {
        ...
        /**
         * @description The type of a property in the graph ontology.
         *     Fixed set for property graph compatibility (e.g., Neo4j).
         * @enum {string}
         */
        ...
        /**
         * @description A node class (label) in the graph ontology. Defines the type of nodes and their properties.
         *     Supports inheritance via parent_class.
         */
        OntologyNodeClass: {
            /** @description Label/class name (e.g., Person, Product). */
            name: string;
            /** @description Parent class for inheritance (optional). */
            parent_class?: string;
            /** @description Typed properties for this node class. */
            properties?: components["schemas"]["OntologyPropertyDef"][];
        };
        /** @description A relationship type (edge) in the graph ontology. Defines directed edges between node classes. */
        OntologyRelationshipType: {
            /** @description Relationship type name (e.g., PURCHASED, WORKS_FOR). */
            name: string;
            /** @description Source node class (start of the edge). */
            source_class: string;
            /** @description Target node class (end of the edge). */
            target_class: string;
            /** @description Typed properties for this relationship type. */
            properties?: components["schemas"]["OntologyPropertyDef"][];
        };
        OntologyInfo: {
            /** @description Name of ontology, relative to parent schema. */
            name?: string;
            /** @description Name of parent catalog. */
            catalog_name?: string;
            /** @description Name of parent schema. */
            schema_name?: string;
            /** @description Full name in form of __catalog_name__.__schema_name__.__ontology_name__. */
            full_name?: string;
            /** @description User-provided free-form text description. */
            comment?: string;
            /** @description Node classes (labels) in the ontology. */
            node_classes?: components["schemas"]["OntologyNodeClass"][];
            /** @description Relationship types (edges) in the ontology. */
            relationship_types?: components["schemas"]["OntologyRelationshipType"][];
            /** @description Username of current owner of ontology. */
            owner?: string;
            /**
             * Format: int64
             * @description Time at which this ontology was created, in epoch milliseconds.
             */
            created_at?: number;
            /** @description Username of ontology creator. */
            created_by?: string;
            /**
             * Format: int64
             * @description Time at which this ontology was last modified, in epoch milliseconds.
             */
            updated_at?: number;
            /** @description Username of user who last modified ontology. */
            updated_by?: string;
        };
        CreateOntology: {
            /** @description Name of ontology, relative to parent schema. */
        ...
        ListOntologiesResponse: {
            /** @description An array of ontology information objects. */
            ontologies?: components["schemas"]["OntologyInfo"][];
            /** @description Opaque token to retrieve the next page of results. Absent if there are no more pages. */
            next_page_token?: string;
        };
        SchemaInfo: {
        ...
        DeltaGetCommitsResponse: {
            ...
            /**
             * Format: int64
             * @description Represents the latest version of the table tracked by UC. If no commits have occurred via UC yet,
...
export interface operations {
    ...
    listOntologies: {
        parameters: {
            query: {
                /** @description Name of parent catalog for ontologies of interest. */
                catalog_name: string;
                /** @description Name of parent schema for ontologies of interest. */
                schema_name: string;
        ...
        requestBody?: never;
        responses: {
            /** @description The ontologies list was successfully retrieved. */
            200: {
                headers: {
                    [name: string]: unknown;
                };
                content: {
                    "application/json": components["schemas"]["ListOntologiesResponse"];
                };
            };
        };
    };
    createOntology: {
        ...
        requestBody?: {
            content: {
                "application/json": components["schemas"]["CreateOntology"];
            };
        };
        responses: {
            /** @description The ontology was successfully created. */
            200: {
                headers: {
                    [name: string]: unknown;
                };
                content: {
                    "application/json": components["schemas"]["OntologyInfo"];
                };
            };
        };
    };
    getOntology: {
        ...
        requestBody?: never;
        responses: {
            /** @description The ontology was successfully retrieved. */
            200: {
                headers: {
                    [name: string]: unknown;
                };
    ...
    deleteOntology: {
        ...
        requestBody?: never;
        responses: {
            /** @description The ontology was successfully deleted. */
            200: {
                headers: {
                    [name: string]: unknown;
                };
    ...
    updateOntology: {
        ...
        requestBody?: {
            content: {
                "application/json": components["schemas"]["UpdateOntology"];
            };
        };
        responses: {
            /** @description The ontology was successfully updated. */
            200: {
                headers: {
                    [name: string]: unknown;
                };
